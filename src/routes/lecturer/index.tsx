...
const SubjectStatisticPage = lazy(
  () => import("../../pages/Profile/Statistic/SubjectStatistic")
);
...
const ExamArchivePage = lazy(
  () => import("../../pages/Library/ExamArchivePage")
);
const ExamArchiveDetail = lazy(
  () => import("../../pages/Library/ExamArchiveDetail")
);
const ExercisesPage = lazy(() => import("../../pages/Room/Exercises"));
const MainTestPage = lazy(() => import("../../pages/Room/MockTest/Main"));
const DetailMockTestPage = lazy(
  () => import("../../pages/Room/MockTest/Detail")
);
